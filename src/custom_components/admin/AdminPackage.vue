...
import AdminPackageTable from "@/custom_components/admin/AdminPackageTable.vue";

// table data

const tableData= ref({
  headers: ["Id", "Opis", "Wysylajacy", "Odbierajacy", "Waga", "Punkt wysylkowy", "Punkt docelowy"],
  rows: []
})
...
<template>
  ...
  <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
    ...
    <!-- <FetchData/> -->
    <AdminPackageTable v-bind="tableData" />
    <!-- <TrackTable/> -->
